...
function generateImagePromptLocally(userPrompt) {
...
async function generateImageWithClipdropAPI(prompt, width = 1024, height = 1024) {
    try {
...
export async function generateThumbnailSVG(options) {
