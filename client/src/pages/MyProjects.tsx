...
const MyProjects = () => {
  ...
  useEffect(()=>{
    ...
    navigate('/')
    toast('Please Login to view Project')
  }
  },[session?.user])
  return (
    <>
          ...
          {loading ? (
            ...
            <div className='py-10 min-h-[80vh]'>
              <div className='flex items-center justify-between mb-12'>
                ...
                <button onClick={()=> navigate('/')} className='flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br from-emerald-500 to-teal-600 hover:opacity-90 active:scale-95 transition-all'>
              ...
              <div className='flex flex-wrap gap-3.5'>
                   {projects.map((project) => (
                     <div onClick={()=> navigate(`/projects/${project.id}`)} key={project.id} className='relative group w-72 max-sm:mx-auto cursor-pointer glass-card rounded-lg overflow-hidden shadow-md group hover:shadow-emerald-700/30 hover:border-emerald-500/40
