...
const navigate = useNavigate()
  ...
  return (
     ...
     <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center mt-20">
          <a href="https://prebuiltui.com" className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm">
          ...
          <button onClick={() => navigate('/thumbnail')} className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm hover:border-indigo-600 transition-colors">
            <span className="bg-indigo-600 text-xs px-3 py-1 rounded-full">TOOL</span>
            <p className="flex items-center gap-2">
