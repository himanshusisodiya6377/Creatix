    ...
    <div className='absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-fade-in fade-in'>
      ...
      <div className='space-y-4 text-black'>
        <div>
            ...
            <textarea value={values.text} onChange={(e)=>handleChange('text',e.target.value)} className='w-full text-sm p-2 border rounded-md border-gray-400 focus:ring-2 focus:ring-indigo-500 outline-none min-h-20'/>
        </div>
        <div>
